    ...
    return [
      {
        ...
        totalizerValue: formatNumber(Math.round(totalizer_24hr?.raw_biogas || 0), 0),
        totalizerUnit: 'Nm³',
        avgLabel: null,
        avgValue: null,
      ...
      },
      {
        ...
        unit: 'Nm³/hr',
        totalizer: 'Totalizer (24 Hr)',
        totalizerValue: formatNumber(Math.round(totalizer_24hr?.purified_gas || 0), 0),
        totalizerUnit: 'Nm³',
        avgLabel: null,
        avgValue: null,
        avgSamples: { samples: totalizer_24hr?.sample_count || 0, expected: totalizer_24hr?.expected_samples || 1440 },
      ...
      },
      {
        ...
        unit: 'Nm³/hr',
        totalizer: 'Totalizer (24 Hr)',
        totalizerValue: formatNumber(Math.round(totalizer_24hr?.product_gas || 0), 0),
        totalizerUnit: 'Nm³',
        avgLabel: null,
        avgValue: null,
        avgSamples: { samples: totalizer_24hr?.sample_count || 0, expected: totalizer_24hr?.expected_samples || 1440 },
      ...
      {
        title: 'H₂S',
        value: Math.round(current?.h2s_content || 0),
        unit: 'ppm',
        totalizer: 'Avg 1 Hr',
        totalizerValue: Math.round(avg_1hr?.h2s_content || 0),
        totalizerUnit: 'ppm',
        avgLabel: 'Avg 12 Hr',
        avgValue: `${Math.round(avg_12hr?.h2s_content || 0)} ppm`,
        avgSamples: { samples: avg_12hr?.sample_count || 0, expected: avg_12hr?.expected_samples || 720 },
        icon: Gauge,
        color: 'bg-rose-600',
